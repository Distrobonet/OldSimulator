...
(cl:defmethod cl:initialize-instance :after ((m <VectorMessage>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VectorMessage)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Simulator-msg:<VectorMessage> is deprecated: use Simulator-msg:VectorMessage instead.")))
